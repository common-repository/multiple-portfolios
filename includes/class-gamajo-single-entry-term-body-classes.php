 ...
 *
 * @package   Multiple_Portfolios_Gamajo_Single_Entry_Term_Body_Classes
 * @author    Gary Jones
 * @license   GPL-2.0+
 ...
 * @author  Gary Jones
 */
class Multiple_Portfolios_Gamajo_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		$taxonomy_objects = get_object_taxonomies( $this->post_type );
		return array_merge( $classes, $taxonomy_objects );
	}
